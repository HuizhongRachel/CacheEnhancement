...
/*victim cache*/
static struct cache_t *vcache = NULL;
...
//****************************************************************************
  if(vcache)
  {
        ...
        return cache_access(vcache, cmd, baddr, NULL, bsize,
...
"                -dtlb dtlb:128:4096:32:r\n"
 ...
 //***********************************************************************
  opt_reg_string(odb, "-cache:v",
		 ...
		 &vcache_opt, "v:64:32:8:l", /* print */TRUE, NULL);
//***************************************************************************
